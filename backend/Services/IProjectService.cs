...
{
    Task<Result<ProjectDto>> CreateProjectAsync(CreateProjectDto dto, string? userName = null, string? userEmail = null);
    ...
    Task<Result<List<ProjectListDto>>> GetUserProjectsAsync(string userEmail, bool includeArchived = false);
